...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  45, 175 }, { 315,  175 } }
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 3000, 3000, 1200, 180 }  // { 50*60, 50*60, 4*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
