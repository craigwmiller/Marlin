...
#define STRING_CONFIG_H_AUTHOR "(Craig, Ender 5 Plus)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  10.20 //30.30
    #define DEFAULT_Ki   1.12 //2.97
    #define DEFAULT_Kd  23.29 //77.40
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  137.82
  #define DEFAULT_bedKi   21.80
  #define DEFAULT_bedKd  580.82
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, -29, -3.3 }
...
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST * 0.8)
...
#define HOMING_FEEDRATE_MM_M { (55*60), (55*60), (24*60) }
